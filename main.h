...
#ifdef __arm__
uint32_t _BFS_TopDown_Branchy_CortexA15(uint32_t* vertexEdges, uint32_t* neighbors, const uint32_t* inputQueue, uint32_t inputVertices, uint32_t* outputQueue, uint32_t* levels, uint32_t currentLevel);
uint32_t _BFS_TopDown_Branchless_CortexA15(uint32_t* vertexEdges, uint32_t* neighbors, const uint32_t* inputQueue, uint32_t inputVertices, uint32_t* outputQueue, uint32_t* levels, uint32_t currentLevel);
#else
...
bool _ConnectedComponents_SV_Branchy_CortexA15(size_t vertexCount, uint32_t* componentMap, uint32_t* vertexEdges, uint32_t* neighbors);
bool _ConnectedComponents_SV_Branchless_CortexA15(size_t vertexCount, uint32_t* componentMap, uint32_t* vertexEdges, uint32_t* neighbors);
